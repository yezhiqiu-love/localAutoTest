...
import com.junqing.qa.exception.MongodbLibraryException;
...
public class MongodbLibrary {
	 ...
	 * @throws MongodbLibraryException 
	 */
	public void connectToServer(String server, String port, String database) throws MongodbLibraryException {
		try {
	 ...
	 * @throws MongodbLibraryException 
	 */
	public void importDocuments(String collectionName, String file) throws MongodbLibraryException {
		try {
	 ...
	 * @throws MongodbLibraryException 
	 */
	public void importDocumentsRowSeperated(String collectionName, String file) throws MongodbLibraryException {
		try {
			String documents = IOUtils.toString(new FileReader(file));
